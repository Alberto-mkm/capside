 ...
 */
function capside_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on capside, use a find and replace
		* to change 'capside' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'capside', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'capside' ),
		)
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'capside_custom_background_args',
			array(
...
add_action( 'after_setup_theme', 'capside_setup' );
 ...
 */
function capside_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'capside' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'capside' ),
